...
In the end we consider the code coverage complete as FSM transitions are completely covered by the Formal verification and the other uncovered bins are unreachable conditions.